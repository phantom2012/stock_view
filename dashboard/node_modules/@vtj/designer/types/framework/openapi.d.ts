...
export declare abstract class OpenApi {
     ...
     * 签名登录
     */
    abstract loginBySign?: (auth?: string | (() => Promise<any>)) => Promise<string[]>;
    /**
     * 判断用户是否登录
     */
     ...
     * 取消对话
     */
    abstract cancelChat?: (chat: AIChat) => Promise<ResponseWrapper<AIChat>>;
    /**
     *  保存对话
     */
     ...
     * AI Completions
     */
    abstract chatCompletions?: (topicId: string, chatId: string, callback?: (data: CompletionChunk | null, done?: boolean) => void, error?: (err: Error, cancel?: boolean) => void) => Promise<() => void>;
    /**
     * 获取AI设置
     */
