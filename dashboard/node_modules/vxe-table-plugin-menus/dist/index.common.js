...
function getClipboardObj() {
  ...
  // 兼容老版本
  var globalConfig = VXETableInstance.config;
...
function setClipboardConfig(clipObj) {
  ...
  if (globalStore && globalStore.clipboard) {
    ...
    // 兼容老版本
    VXETableInstance.config.clipboard = clipObj;
  }
}
var copyElem;
 ...
 */
var VXETablePluginMenus = exports.VXETablePluginMenus = {
  config: pluginSetup,
...
// }
var _default = exports["default"] = VXETablePluginMenus;